...
import { useAudioContext } from '@/hooks/useAudio/useAudioContext';
...
export function Main() {
  ...
  return (
    <div className="sm-gap-4 bg-pure-black grid h-screen grid-cols-1 grid-rows-5 gap-8 py-8 sm:py-0">
      ...
      <div className="col-start-1 row-span-3 row-start-2 flex items-center justify-center">
        {!isSpeaking && <TextPresentation />}
      </div>
      <div className="col-start-1 row-span-5 row-start-1 flex items-center justify-center">
        {isLoading && <LoadingVideo />}
      </div>
      <div className="col-start-1 row-span-5 row-start-1 flex items-center justify-center sm:row-span-3 sm:row-start-2">
