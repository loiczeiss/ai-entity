...
export function Main() {
  ...
  return (
    ...
    <div
      className="grid h-screen grid-cols-1 grid-rows-5 gap-8 sm-gap-4 py-8 sm:py-0 bg-pure-black "

    >
      <div className="col-start-1 row-span-1 row-start-1 flex items-center justify-center"><Header/></div>
