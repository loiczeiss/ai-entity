...
export function TextPresentation() {
  ...
  return (
      <motion.div
          className={cn(
              'mx-16 my-4 flex h-full px-32 flex-col items-center justify-center space-y-2 rounded-xl p-2',
              shouldRender ? '' : 'hidden',
          )}
      >
        {useTypewriter({
          ...
          speed: 30,
          delay: 10000,
          className: 'text-alien-glow font-semibold rounded-md text-center text-xs sm:text-xl',
        })}
        {useTypewriter({
          ...
          speed: 30,
          delay: 15940,
          className: 'text-alien-glow font-semibold text-center text-xs sm:text-xl',
        })}
      </motion.div>
  );
}
